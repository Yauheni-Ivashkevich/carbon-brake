...
export const StatsOverview: React.FC<StatsOverviewProps> = ({ stats, currentLang }) => {
  ...
  const phoneChargesSaved = Math.round(stats.totalEnergySavedWh / 12);
  const co2KmCarEquivalent = (stats.totalCo2SavedGrams / 120).toFixed(1);
  ...
  return (
    <div className="w-full my-4 sm:my-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3">
        {/* Metric 1: Total CO2 */}
        <div className="p-3.5 sm:p-4 rounded-xl bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 flex flex-col justify-between shadow-xs">
          <div className="flex items-center justify-between mb-1.5 text-zinc-500 dark:text-zinc-400 text-xs">
        ...
        <div className="p-3.5 sm:p-4 rounded-xl bg-white dark:bg-zinc-900/80 border border-zinc-200 dark:border-zinc-800 flex flex-col justify-between shadow-xs">
          ...
          <p className="text-[10px] text-zinc-500 mt-1">
            ≈ {stats.totalWaterSavedLiters * 4} glasses of water
          </p>
        </div>
